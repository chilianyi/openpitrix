...
func (p *Parser) ParseAddClusterNode(clusterConf app.ClusterConf, clusterWrapper *models.ClusterWrapper) error {
...
func (p *Parser) Parse(clusterConf app.ClusterConf, clusterWrapper *models.ClusterWrapper) error {
